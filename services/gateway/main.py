...
2. ВЪВЕДЕНИЕ - Основание, поставени задачи
3. ИЗСЛЕДВАНА ДОКУМЕНТАЦИЯ - Списък документи
4. ФАКТИЧЕСКА ОБСТАНОВКА - Място, участници, щети
5. ТЕХНИЧЕСКО ИЗСЛЕДВАНЕ - Механизъм на ПТП, изчисления, цитати от Наредба 24
6. ИЗВОДИ - Заключения, технически причини
7. ОТГОВОРИ НА ВЪПРОСИТЕ - Подробни отговори
