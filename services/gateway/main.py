...
3. ФОРМУЛИ - в техническото изследване цитирайте:
   - V = √(2·μ·g·S) за скорост от спирачен път
   - Закон за запазване на импулса: m₁V₁ + m₂V₂ = m₁V₁' + m₂V₂'
   - ΔV (Delta-V) = промяна на скоростта
